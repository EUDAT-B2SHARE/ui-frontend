...
b2Controllers.controller('HomeCtrl',
    ['$scope', '$alert', '$location', '$timeout', '$rootScope', '$window', 'Record', 'Helper', 'Upload', 'Session',
...
b2Controllers.controller('DefaultCtrl',
    ['$scope', '$alert', '$location', '$timeout', '$rootScope', '$window', 'Breadcrumbs', 'PageTitle', 'Session', 'Helper',
    function($scope, $alert, $location, $timeout, $rootScope, $window, Breadcrumbs, PageTitle, Session, Helper) {
        ...
        $scope.$on('$viewContentLoaded', function(){
            ...
            // a href hooks
            angular.element('a').each(function(i, anch) {
                var a = angular.element(anch);
...
b2Controllers.controller('AboutCtrl',
    ['$scope', '$rootScope',
...
b2Controllers.controller('AboutListCtrl',
    ['$scope', '$rootScope',
    function($scope, $rootScope) {
        // $rootScope.PageTitle.reset();
    }]
...
b2Controllers.controller('HelpCtrl',
    ['$scope', '$rootScope',
    function($scope, $rootScope) {
        // $rootScope.PageTitle.reset();
    }]
...
b2Controllers.controller('HelpListCtrl',
    ['$scope', '$rootScope',
    function($scope, $rootScope) {
        // $rootScope.PageTitle.reset();
    }]
...
b2Controllers.controller('UserCtrl',
    ['$scope', 'User', '$alert', '$timeout', '$rootScope', '$window', '$location', 'Session',
...
b2Controllers.controller('UserListCtrl',
    ['$scope', 'User', '$alert', '$timeout', '$rootScope', '$window', '$location',
    function($scope, User, $alert, $timeout, $rootScope, $window, $location) {
        // $rootScope.PageTitle.reset();
    }]
);

b2Controllers.controller('UserNotifyCtrl',
    ['$scope', 'User', '$alert', '$timeout', '$rootScope', '$window', '$location', '$routeParams',
...
b2Controllers.controller('SearchCtrl',
...
b2Controllers.controller('SearchListCtrl',
    ['$scope', '$routeParams', '$location',
    function($scope, $routeParams, $location) {
    }]
);

b2Controllers.controller('RecordListCtrl',
    ['$scope', '$routeParams', 'Record', '$rootScope', '$alert', '$location', 'Pagination',
...
b2Controllers.controller('RecordCtrl',
    ['$scope', '$routeParams', 'Record', '$rootScope', '$alert', '$window',
...
b2Controllers.controller('RecordCreateCtrl',
    ['$scope', '$routeParams', 'Record', '$rootScope', '$alert', '$window', 'Session', 'Helper', '$timeout',
    function($scope, $routeParams, Record, $rootScope, $alert, $window, Session, Helper, $timeout) {
        ...
        $rootScope.uploadForm.submitForm = function(){
            console.log("uploadForm.submitForm", $rootScope.uploadForm);
            if(!$rootScope.uploadForm.files){
                $rootScope.Notify.flash_add($alert, 'record', 'Please provide files for the new record', 'warning');
                return;
            }
        };
        $rootScope.uploadForm.change = function(files){
            console.log("uploadForm.change", $rootScope.uploadForm, files);
            $timeout(function() {
                angular.element('.media').media();
            }, 100);
        };
